...
//go:generate $PWD/.bin/go-mockgen -f github.com/sourcegraph/sourcegraph/enterprise/cmd/frontend/internal/codeintel/resolvers -i CodeIntelAPI -i GitserverClient -i DBStore -i LSIFStore -i IndexEnqueuer -o mock_iface_test.go
